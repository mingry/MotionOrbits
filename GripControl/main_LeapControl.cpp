...
static SkeletalMotion	original_motion;
static SkeletalMotion	edited_motion;
static MotionEdit		motion_edit;
static DrawingTool		drawing_tool;
...
void initMotion()
{
	original_motion.importFromBVH( PATH_BVH );
}
...
//	glRotatef( 45.0f, 0, 1, 0 );
  ...
  */
	drawing_tool.drawPose( &original_motion, current_frame, 1 );
...
void idle()
{
	...
	if( is_playing )
	{
		int num_frames = original_motion.getNumFrames();
